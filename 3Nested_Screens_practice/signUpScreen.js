...
const logginScreen = () => {
  ...
  function navigate() {
    navigation.reset({
      ...
      routes: [
        {
          name: 'Login',
          params: { username: usernameVerify, password: passwordVerify },
        },
      ],
    });
    setUsernameVerify('');
  ...
  function doSubmit() {
    ...
    if (isValid) {
      ...
      setTimeout(() => {
        setIsLoading(false);
        Alert.alert('You have been signup');
        setUsernameVerify(userName);
        setPasswordVerrify(password);
        setPassword('');
        setUserName('');
      ...
      Alert.alert('Not fill the Register proper');
    }
  }
  ...
  return (
    ...
    >
      ...
      <View style={styles.TextInput}>
        ...
        />
        <Text style={{ color: 'red', position: 'absolute', bottom: -18 }}>
          {userNameError}
        </Text>
      </View>
      ...
      <View style={[styles.TextInput]}>
        <TextInput
          style={{ fontSize: 17, color: 'black', fontFamily: Fonts.MEDUIM }}
          ref={passwordRef}
          onChangeText={text => {
            setPassword(text);
      ...
      {isLoading ? (
        <View style={[styles.button, { backgroundColor: '#fccaa5' }]}>
      ...
      <View style={styles.registor}>
        <Text style={{ fontSize: scale(14), fontFamily: Fonts.MEDUIM }}>
